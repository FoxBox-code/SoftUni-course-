...
{
    public static void Main(string[] args)                 //WE might have a problem with the string builder if so change the last APPENDLINE TO APPEND!!! OR maybe WE need TO USE .TRIM(Note to self dont use trim)
    {
